    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'top-bar' },
          _react2.default.createElement('div', { id: 'power-light' }),
          this.state.on ? _react2.default.createElement('img', { id: 'speaker', src: './Images/speaker-on.png', alt: 'speaker-volume-icon' }) : _react2.default.createElement('img', { id: 'speaker', src: './Images/speaker.svg', alt: 'speaker-volume-icon' }),
          _react2.default.createElement(
            'div',
            { id: 'volume' },
            _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'drum-machine-contents' },
          _react2.default.createElement(_DrumPads2.default, { on: this.state.on,
            pads: _drumPads2.default,
...
var DrumPads = function DrumPads(props) {
  return _react2.default.createElement(
    ...
    props.pads.map(function (pad) {
      return _react2.default.createElement(_DrumPad2.default, { key: pad.description,
        on: props.on,
        audio: pad,
        volume: props.volume,
  ...
  function DrumPad() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DrumPad.__proto__ || Object.getPrototypeOf(DrumPad)).call.apply(_ref, [this].concat(args))), _this), _this.play = function () {
      if (_this.props.on) {
        ...
        _this.props.handleChangeDescription(_this.props.audio.description);
      }
...
// module
exports.push([module.i, "html {\n  font-size: 62.5%; }\n\nbody {\n  background: silver;\n  font-family: Helvetica, Arial, sans-serif;\n  font-size: 1.6rem; }\n\nbutton {\n  cursor: pointer; }\n\nbutton:disabled {\n  cursor: default; }\n\n#drum-machine {\n  background: linear-gradient(black 1%, #1a1a1a, black 5%, #0d0d0d);\n  border-radius: 5px;\n  height: 60%;\n  margin: 100px auto;\n  max-height: 440px;\n  max-width: 330px;\n  width: 60%; }\n\n#top-bar {\n  color: white;\n  display: flex;\n  height: 45px;\n  justify-content: space-around;\n  padding-top: 10px; }\n\n#power-button {\n  background: green;\n  border-radius: 5px;\n  box-shadow: 2px 2px #004d00;\n  cursor: pointer;\n  font-weight: bold;\n  height: 25px;\n  margin-top: 15px;\n  text-align: center;\n  width: 50px; }\n  #power-button p {\n    margin-top: 4px; }\n\n#power-button:active {\n  box-shadow: 0 0;\n  margin-top: 17px; }\n\n#speaker {\n  height: 35px;\n  padding-top: 8px;\n  width: 35px; }\n\n#volume {\n  width: 50%; }\n\n#drum-machine-contents {\n  display: flex; }\n\n#drum-pads {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-evenly;\n  margin: 2px;\n  margin-bottom: 10px; }\n\n.drum-pad {\n  background: grey;\n  border-radius: 5px;\n  box-shadow: 2px 2px #676767;\n  cursor: pointer;\n  font-size: 200%;\n  height: 90px;\n  margin: 7px;\n  text-align: center;\n  width: 90px; }\n\n.drum-pad:active {\n  background: radial-gradient(#9a9a9a, grey);\n  box-shadow: 0 0;\n  margin-bottom: -7px;\n  margin-left: 7px;\n  margin-right: 7px;\n  margin-top: 7px; }\n\n#display {\n  background: lightGrey;\n  border-radius: 5px;\n  color: black;\n  font-weight: bold;\n  font-size: 130%;\n  height: 25px;\n  margin: 10px auto;\n  text-align: center;\n  width: 50%; }\n", ""]);
